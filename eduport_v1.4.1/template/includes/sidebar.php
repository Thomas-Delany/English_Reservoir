...
<div class="d-none d-md-flex flex-column flex-shrink-0 p-3 bg-light rounded-3">
  <ul class="nav nav-pills flex-column mb-auto">
    ...
    <li class="nav-item"><a href="https://cursos.englishreservoir.com/p/b2-cambridge-first" class="nav-link"><i class="bi bi-dash me-2"></i>B2 First</a></li>

    <li class="nav-item"><a href="https://cursos.englishreservoir.com/p/c1-cambridge-advanced" class="nav-link"><i class="bi bi-dash me-2"></i>C1 Advanced</a></li>

    <li class="nav-item"><a href="https://cursos.englishreservoir.com/p/c2-cambridge-proficiency" class="nav-link"><i class="bi bi-dash me-2"></i>C2 Proficiency</a></li>

    <li class="nav-item"><a href="https://cursos.englishreservoir.com/p/gramatica-esencial-metodo-divertido" class="nav-link"><i class="bi bi-dash me-2"></i>Gramática Esencial</a></li>

    <li class="nav-item"><a href="https://cursos.englishreservoir.com/p/pronunciacion-en-ingles" class="nav-link"><i class="bi bi-dash me-2"></i>Pronunciación en inglés</a></li>

    <li class="nav-item"><a href="https://cursos.englishreservoir.com/p/verbos-en-ingles-metodo-divertido" class="nav-link"><i class="bi bi-dash me-2"></i>Verbos en Inglés</a></li>
    ...
    <li class="nav-item"><a href="https://www.facebook.com/Englishreservoir/" target="_blank" rel="noopener noreferrer" class="nav-link"><i class="bi bi-facebook me-2"></i>Facebook</a></li>

    <li class="nav-item"><a href="https://twitter.com/EN_Reservoir" target="_blank" rel="noopener noreferrer" class="nav-link"><i class="bi bi-twitter me-2"></i>Twitter/X</a></li>

    <li class="nav-item"><a href="https://www.instagram.com/english_reservoir" target="_blank" rel="noopener noreferrer" class="nav-link"><i class="bi bi-instagram me-2"></i>Instagram</a></li>
