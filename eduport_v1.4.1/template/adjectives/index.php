...
<div class="container mt-4">
    <div class="row">
        <div class="col-12">
            <img src="../assets/images/adjectives.png" class="img-fluid rounded-3 mb-5" alt="adjectives">
        </div>
        <!-- Table of Contents -->
        ...
        <div class="col-md-12">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/N4-r-GFi28g?si=Eu8wNNHtD2PTgLJa" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
