<!-- Common Pronunciation Mistakes.php -->
<?php
$page_title = "Common Pronunciation Mistakes";
$page_heading = "Common Pronunciation Mistakes";
// Page specific content with HTML and Bootstrap elements
$page_content = <<<HTML
<div class="container mt-4">
    <div class="row">
        <div class="col-12">
            <img src="../assets/images/english-pronunciation-mistakes.png" class="img-fluid rounded-3 mb-5" alt="english pronunciation mistakes">
        </div>
        <!-- Table of Contents -->
