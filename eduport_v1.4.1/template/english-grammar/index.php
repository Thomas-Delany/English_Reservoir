...
$page_content = <<<HTML
        <div class="col-12">
            <img src="../assets/images/english-grammar.png" class="img-fluid rounded-3 mb-5" alt="English Grammar">
        </div>
        <!-- Table of Contents -->
        ...
        <div class="col-md-12">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/XwtznfOAwtU?si=ki--d2uehTopSq0l" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
